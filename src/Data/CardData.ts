...
export const ExampleCardData1 = [
    ...
    {
        title: '1856 Republican National Convention', 
        desc: 'The 1856 Republican National Convention, held in Philadelphia, Pennsylvania, nominated John C. Frémont for President and William L. Dayton for Vice President.', 
        href: 'https://en.wikipedia.org/wiki/1856_Republican_National_Convention'
    },
    {
        title: 'California', 
        desc: 'California is a state on the west coast of the United States. With over 39.3 million residents across a total area of approximately 163,696 square miles, it is the most populous and the third-largest U.S. state by area.', 
        href: 'https://en.wikipedia.org/wiki/California'
    },
    {
        title: 'Steve Jobs', 
        desc: 'Steve Jobs was an American business magnate, industrial designer, inventor, and media proprietor. He was the chairman, chief executive officer (CEO), and co-founder of Apple Inc.', 
